...
var journalMapping = {
    ...
    "1380-7854" : "!048518425!", // Medieval enrunningThreadCounters
    "1570-0674" : "!048518425!", // Medieval enrunningThreadCounters
...
var issnPhysicalFormMapping = {
    ...
    "1380-7854" : "A", // Medieval enrunningThreadCounters
    "1570-0674" : "A", // Medieval enrunningThreadCounters
...
var issnSsgMapping = {
    ...
    "1380-7854" : "0; 1", // Medieval enrunningThreadCounters
    "1570-0674" : "0; 1", // Medieval enrunningThreadCounters
...
function doExport() {
    ...
    while ((item = Zotero.nextItem())) {
        ...
        if (article && licenceField === "l") { // wenn Position 4 = "l" dann Ooul
            ...
            addLine(currentItemId, "0500", physicalForm+"o"+cataloguingStatusO);
        }
        ...
        while (item.creators.length>0) {
            ...
            if (creator.creatorType == "author") {
                ...
                //Lookup für Autoren
                if (authorName[0] != "!") {
                    var lookupUrl = "http://swb.bsz-bw.de/DB=2.104/SET=70/TTL=1/CMD?SGE=&ACT=SRCHM&MATCFILTER=Y&MATCSET=Y&NOSCAN=Y&PARSE_MNEMONICS=N&PARSE_OPWORDS=N&PARSE_OLDSETS=N&IMPLAND=Y&NOABS=Y&ACT0=SRCHA&SHRTST=50&IKT0=1&TRM0=" + encodeURIComponent(authorName) +"&ACT1=*&IKT1=2057&TRM1=*&ACT2=*&IKT2=8977&TRM2=theolog*&ACT3=-&IKT3=8978-&TRM3=1[1%2C2%2C3%2C4%2C5%2C6%2C7%2C8][0%2C1%2C2%2C3%2C4%2C5%2C6%2C7%2C8%2C9][0%2C1%2C2%2C3%2C4%2C5%2C6%2C7%2C8%2C9]";
                    ...
                    processDocumentsCustom(lookupUrl,
                        ...
                        function(doc, url, threadParams){
                            ...
                            if (ppn) {
                                ...
                                addLine(threadParams["currentItemId"], threadParams["code"], threadParams["authorName"]);
                            }
        ...
        if (item.url && physicalForm === "O" && licenceField === "l") {
            addLine(currentItemId, "4085", "$u" + item.url + "$xH$xR$zLF");
        ...
        if (item.abstractNote) {
            addLine(currentItemId, "4207", item.abstractNote.replace("<i>", "\'").replace("</i>", "\'").replace("<br/>", "").replace("Zusammenfassung", "").replace(" Summary", "").replace("", "").replace(/�/g, '-').replace(/&#160;/g, ""));
        }
        /* } else (!item.abstractNote){
            addLine(currentItemId, "4207");
        }
        ...
        */
        ...
        if (item.itemType == "journalArticle" || item.itemType == "magazineArticle") {
            if (item.ISSN && journalMapping[ZU.cleanISSN(item.ISSN)]) {
                ...
                addLine(currentItemId, "4241", "Enthalten in"  + item.publicationTitle);
            }
            ...
            if (item.itemType == "journalArticle") {
                addLine(currentItemId, "7100$jn", "");
                addLine(currentItemId, "8002", "ixzs;ixzo");
